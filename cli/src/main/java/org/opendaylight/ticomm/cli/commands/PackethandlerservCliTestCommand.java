 ...
 */
package org.opendaylight.ticomm.cli.commands;
...
public class PackethandlerservCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(PackethandlerservCliTestCommand.class);
    protected final PackethandlerservCliCommands service;

    public PackethandlerservCliTestCommand(final PackethandlerservCliCommands service) {
